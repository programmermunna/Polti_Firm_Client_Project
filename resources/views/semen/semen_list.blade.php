        ...
        <div class="col-md-12 col-sm-12 ">
            ...
            <div class="page_header">
                <div class="page_header_menu">
                    <a class="btn btn-sm btn-primary" href="{{ route('semen.create') }}">Create Semen</a>
                </div>
            </div>
                                            ...
                                            @foreach ($semens as $key => $semen)
                                                <tr class="list-item">
                                                    ...
                                                    <td>
                                                        ...
                                                        data-id="{{ $semen->id }}" data-name="{{ $semen->name }}" data-status="{{ $semen->status }}">
                                                            <i class="fa-regular fa-pen-to-square"></i>
                                                        </button>
                                                        <button class="btn btn-sm btn-danger deleteButton" data-id="{{ $semen->id }}">
