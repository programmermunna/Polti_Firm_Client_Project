    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 ">
            ...
            <div class="x_panel">
                ...
                <div class="x_title">
                    <h2 style="font-weight: bold; color:#000;">Designation List</h2>
                                        ...
                                        @if (count($designations) > 0)
                                            ...
                                            @foreach ($designations as $key => $designation)
                                                <tr class="list-item">
                                                    ...
                                                    <td>{{ ucfirst($designation->description) }}</td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <button class="btn btn-sm btn-primary editBtn" data-toggle="modal"
                                                            data-target="#myModal" data-id="{{ $designation->id }}"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="" action="{{ route('designation.edit') }}" method="post" novalidate>
                        @csrf
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="" action="{{ route('designation.store') }}" method="post" novalidate>
                        @csrf
                        <div class="field item form-group">
                            <label class="col-form-label col-md-3 col-sm-3  label-align">
                                Name
            ...
            $('.deleteButton').click(function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            type: 'GET',
                            url: '/designation/delete/' + designationId,
    ...
    <script>
        $(document).ready(function() {
            $('.editBtn').click(function() {
                ...
                $('input[name="designation_id"]').val(designationData.id);
                $('input[name="name"]').val(designationData.name);
                $('textarea[name="description"]').val(designationData.description);
                $('#status').val(designationData.status);
