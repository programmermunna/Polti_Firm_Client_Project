                                            ...
                                            @foreach ($units as $key => $unit)
                                                <tr class="list-item">
                                                    ...
                                                    <td>
                                                        ...
                                                        data-id="{{ $unit->id }}" data-name="{{ $unit->name }}" data-status="{{ $unit->status }}">
                                                            <i class="fa-regular fa-pen-to-square"></i>
                                                        </button>
                                                        <button class="btn btn-sm btn-danger deleteButton" data-id="{{ $unit->id }}">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="" action="{{ route('unit.store') }}" method="post" novalidate>
                        @csrf
    ...
    <div class="modal fade" id="myModal">
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                ...
                <form class="" action="{{ route('unit.edit') }}" method="post" novalidate>
                    @csrf
    ...
    <script>
        $(document).ready(function(){
            $('.editBtn').click(function(){
                ...
                $('input[name="unit_id"]').val(unitData.id);
                $('input[name="name"]').val(unitData.name);
                $('select[name="status"]').val(unitData.status);
